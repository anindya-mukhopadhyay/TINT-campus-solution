...
class StratingWidget extends StatefulWidget {
  ...
  static String routeName = 'strating';
  static String routePath = '/strating';

  @override
  State<StratingWidget> createState() => _StratingWidgetState();
}

class _StratingWidgetState extends State<StratingWidget>
    with TickerProviderStateMixin {
  late StratingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StratingModel());
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        fit: BoxFit.fill,
                                        image: Image.asset(
                                          'assets/images/techno-india-logo.png',
                                        ).image,
                                      ),
                                      shape: BoxShape.circle,
                                      border: Border.all(
